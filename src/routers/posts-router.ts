...
postsRouter.post('/:postId/comments', createPostValidationC, authorizationValidation, async (req: Request, res: Response) => { /// jn async and for end function create new middleware
